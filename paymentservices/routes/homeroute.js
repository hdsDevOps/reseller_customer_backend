...
/**
 * @swagger
 * /payment/api/v1/updatepaymentmethod:
 *   post:
...
/**
 * @swagger
 * /payment/api/v1/getbillinghistory:
 *   post:
 ...
 *         description: Internal server error
 */
router.post('/getbillinghistory',verifyToken, async (req, res) => {
  try {
 ...
 *         description: Internal server error
 */
router.post('/downloadbillinghistory',verifyToken, async (req, res) => {
  try {
 ...
 *         description: Internal server error
 */
router.post('/exportbillinghistory',verifyToken, async (req, res) => {
  try {
